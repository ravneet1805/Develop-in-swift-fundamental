...
var favoriteBook = Book(title: "ABHJFJK", author: "VDCSHGJ", pages: 675, price: 23.98)
print(favoriteBook)
/*:
...
var hp = Laptop(screenSize: 12, repairCount: 2,yearPurchased: 2021)
print("\(mac)  ,  \(hp)")
/*:
...
struct Height{
    ...
    init(heightInInches: Double){
        ...
        var heightcm = heightInInches*2.54
        self.heightInCentimeters = heightcm
    }
    init(heightInCentimeters: Double){
        self.heightInCentimeters = heightInCentimeters
        var heigthInches = heightInCentimeters/2.54
        self.heightInInches = heigthInches
    }
}
...
var height2 = Height(heightInInches: 65)
print("\(height2.heightInInches) , \(height2.heightInCentimeters)")
...
var height1 = Height(heightInCentimeters: 165)
