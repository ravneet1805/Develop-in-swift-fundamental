 ...
 */
var walkingChallenges : Array<String> = ["Walk 3 miles a Day", "Walk 1/2 mile an hour"]
var runningChallenges : Array<String> = ["Run 5 times a week" , "Run for 15 minutes"]
...
var committedChallenges : Array<String> = []
