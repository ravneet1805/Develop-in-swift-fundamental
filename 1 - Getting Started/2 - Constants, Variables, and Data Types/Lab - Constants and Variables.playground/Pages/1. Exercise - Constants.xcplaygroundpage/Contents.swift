...
//friends = 1
print("Previously friends was declared with let so it gave an error. let is used to declare a constant value. Its value will not change throughout the code")
